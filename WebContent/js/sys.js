...
$(".cons").height(bdHeight - 105);
$(".left-nav").height(bdHeight - 10);
/*$(".content").width(bdWidth - 220);*/


/*导航栏选中改变颜色*/
$(".navs-lists").on("click", "a", function() {
	var index = $(".navs-lists a").index(this);
	$(".navs-lists a").eq(index).addClass("selected-list");
	$(".navs-lists a").eq(index).parent().siblings(".list").find("a").removeClass("selected-list");
});
