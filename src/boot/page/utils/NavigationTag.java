...
/**
 * 显示格式  首页 上一页  123456 下一页 尾页
 */
public class NavigationTag extends TagSupport {
	static final long serialVersionUID = 2372405317744358833L;
	/**
	 * request 中用于保存Page<>()对象的变量名，默认为page 
	 */
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			writer.print("<nav><ul class=\"pagination pagination-sm\">");
			//首页链接路径
...
writer.print("<li class=\"disabled\"><a href=\"#\">" + "上一页</a></li>");
			...
			// 显示当前页码的前两页码和后两页吗
			// 若1则1 2 3 4 5 若2 1 2 3 4 5 若3 1 2 3 4 5 
			// 若4 23456  若10 8 9 10 11 12
			int indexPage =1;
			if(page.getPage() - 2 <=0){
				indexPage=1;
